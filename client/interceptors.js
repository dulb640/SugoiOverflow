angular.module('sugoiOverflow.interceptors', ['sugoiOverflow.shared'])
    ...
    .factory('logoutOn401Interceptor', ['$rootScope', '$q', '$window', function ($rootScope, $q, $window) {
        'use strict';
    ...
    .factory('errorOn403Interceptor', ['$rootScope', '$q', '$injector', function ($rootScope, $q, $injector) {
        'use strict';
    ...
    .factory('errorOn404Interceptor', ['$rootScope', '$q', '$injector', function ($rootScope, $q, $injector) {
        'use strict';
    ...
    .factory('errorOn500Interceptor', ['$rootScope', '$q', '$injector','$window', function ($rootScope, $q, $injector, $window) {
        'use strict';
